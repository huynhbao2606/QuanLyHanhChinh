    ...
    <div class="row">
        ...
        <form action="index.php?act=upd_nv" method="post" enctype="multipart/form-data">
            <div class="mb-3 row w-50 m-auto">
                ...
                <div class="col-sm-10">
                    <input name="tenNV" type="text"  class="form-control" id="tenNv" value="<?=$kqOne['tennv'];?>" required>
                </div>
            </div>
            <div class="mb-3 row w-50 m-auto">
                <label for="taiKhoan" class="col-sm-2 col-form-label">Tài Khoản</label>
                <div class="col-sm-10">
                    <input name="taiKhoan" type="text" class="form-control"  id="taiKhoan" value="<?=$kqOne['username'];?>" required>
                </div>
            </div>
            <div class="mb-3 row w-50 m-auto">
            ...
            <div class="mb-3 row w-50 m-auto">
                ...
                <div class="col-sm-10">
                    <div class="w-25">
                        <input name="ngaySinh" type="date" class="form-control" id="ngaySinh" value="<?=$kqOne['ngaysinh'];?>" required>
                    </div>
                </div>
            </div>
            <div class="mb-3 row w-50 m-auto">
                ...
                <div class="col-sm-10">
                    <select class="form-select shadow-sm w-25" name="maPhong" id="phongBan" value="<?=$kqOne['maphong'];?>">
                        <?php
                        $pb = new funcPB();
                        $kqpb = $pb->all_pb();
                        foreach ($kqpb as $pb) {
            ...
            <div class="mb-3 row w-50 m-auto">
                ...
                <div class="col-sm-10">
                    <select class="form-select w-25 " name="chucVu" id="chucVu" value="<?=$kqOne['macv'];?>">
                        <?php
                        $cv = new funcCV();
                        $kqcv = $cv->All_CV();
                        foreach ($kqcv as $cv) {
