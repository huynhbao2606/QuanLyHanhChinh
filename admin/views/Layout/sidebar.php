<div class="col-2">
    <div class="list-group" id="list-tab" role="tablist">
        ...
        <a class="list-group-item <?php echo isset($_GET['act'] ) && $_GET['act'] == 'phongban'  ? 'active' : false ;?>" href="?act=phongban"><i class="fa-solid fa-building-user"></i> Phòng Ban</a>
        ...
        <a class="list-group-item <?php echo isset($_GET['act'] ) && $_GET['act'] == 'logout'  ? 'active' : false ;?>" href="../login.php"><i class="fa-solid fa-right-from-bracket"></i> Thoát</a>
    </div>
    <hr>
    <div style="width:100%;height:0;padding-bottom:83%;position:relative;">
        <img src="https://64.media.tumblr.com/tumblr_lm5hpaepoV1qf8l3vo1_400.gif" alt="rich-roll" width="285" "/>
    </div>
    <div style="width:100%;height:0;padding-bottom:83%;position:relative;">
    <audio controls autoplay hidden>
        <source src="/media/allmy.mp3" type="audio/ogg">
    </audio>
    </div>
</div>
