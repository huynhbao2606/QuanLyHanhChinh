<?php
class funcNP extends db
{
    public function __construct()
    {
    }

    public function all_np(): false|array
    {
        $conn = $this->getDB();
    ...
    public function update_np($id, $tenNV, $userName, $password, $maPhong, $gioiTinh, $ngaySinh, $maCV, $hinh)
    {
        $conn = $this->getDB();
    ...
    public function insert_np($tenNV, $userName, $password, $maPhong, $gioiTinh, $ngaySinh, $maCV, $hinh)
    {
        $conn = $this->getDB();
